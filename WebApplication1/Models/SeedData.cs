    ...
    public static class SeedData
    {
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            AppContext context = app.ApplicationServices
                .CreateScope().ServiceProvider.GetRequiredService<AppContext>();
                ...
                context.Products.AddOrUpdate(
                     new Product
                     {
                         ...
                         Recipe = "Hướng Dẫn Cách Làm Kem Socola" + "Bước 1: Đầu tiên bạn nên chuẩn bị một cái nồi, sau đó cho lần lượt các nguyên liệu kem tươi, bột cacao, đường vào nồi, khuấy đều. Đặt lên bếp, đun cho đến khi đường tan chảy hoàn toàn."
                                ...
                                + "Bước 4: Khi kem đã nguội đặt vào ngăn đông của tủ lạnh, cứ 1 tiếng bạn lại xới kem lên để tránh fsddfsesdbị đóng đá.Làm như vậy khoảng 2 – 3 lần rồi để kem đông thêm 3 giờ nữa là có thể dùng được.",
